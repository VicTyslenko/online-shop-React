...
```
cd existing_repo
git remote add origin https://gitlab.com/igor_dan/finale-project-fe02.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/igor_dan/finale-project-fe02/-/settings/integrations)
