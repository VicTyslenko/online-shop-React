...
import { FiltersButton, StyledBoxTypography, StyledCrossIcon, StyledTypography } from "./ProductFilters.styles";
	...
	return (
		<>
			...
			<Drawer anchor="top" open={open} onClose={handleClose}>
				<StyledBoxTypography>
					<StyledTypography variant="h5">Filters</StyledTypography>
