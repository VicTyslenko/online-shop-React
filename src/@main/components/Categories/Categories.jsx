...
import CategoryNamePlank from '../CategoryNamePlank/CategoryNamePlank';

function Categories() {
	return (
		<Container sx={{ backgroundColor: 'black', paddingBottom: '210px', paddingTop: '226px' }}>
			<h1
				style={{ color: '#fff', fontSize: '24px', fontWeight: '400', marginLeft: '60px', marginBottom: '35px' }}
			>
				Shop by Category
			</h1>
			<div style={{ display: 'flex', marginBottom: '30px' }}>
				...
				<Link
					...
					sx={{ position: 'relative', paddingRight: '16px', paddingLeft: '16px' }}
				>
					<img
